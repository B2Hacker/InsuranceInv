        ...
        <Modal show={open} onHide={handleClose}>
            ...
            <Modal.Footer>
                ...
                <div onClick={createCategory}>
                    {editMode ? <button type="button" className="btn btn-success" onClick={() => handleClickUpdateCategory()}><i className="fas fa-edit"></i>&nbsp;Update</button>
                        :
                        <button type="button" className="btn btn-success" onClick={() => handleClickOnCreateNewCategory()}><i className="fas fa-save"></i>&nbsp;Save</button>}
                </div>
            </Modal.Footer>
        </Modal>
    )

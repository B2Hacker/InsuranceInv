        ...
        <Modal show={open} onHide={handleClose}>
            ...
            <Modal.Footer>
                ...
                <div onClick={createContract}>
                    {editMode ? <button type="button" className="btn btn-success" onClick={() => handleClickUpdateContract()}><i className="fas fa-edit"></i>&nbsp;Update</button>
                        :
                        <button type="button" className="btn btn-success" onClick={() => handleClickOnCreateNewContract()}><i className="fas fa-save"></i>&nbsp;Save</button>}
                </div>
            </Modal.Footer>
